...
from classes.class_note_book import Note
...
class ContactBook(UserDict):
    ...
    def __init__(self, file_path=os.path.join("saved_files", "contact_book")):
        super().__init__()
...
class Record:
    ...
    def __init__(self, name, phone=None, email=None, address=None, birthday=None, note=None):
        self.name = Name(name)
        ...
        self.note = Note(note) if note else "Empty"
